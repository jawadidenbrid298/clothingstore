...
function Header() {
  ...
  return (
    <>
      {isVisible && (
        <div className='bg-black text-white flex justify-between items-center top-0 left-0 w-full z-50 px-2 py-0.1'>
          {/* Left side: Centered Text */}
          <div className='flex justify-center items-center w-full'>
            <span className='text-sm sm:text-base md:text-lg font-medium'>
              Sign up and get 20% off your first order.{' '}
              <a href='/auth/signup' className='underline text-yellow-400'>
                Sign Up Now
              </a>
            </span>
          </div>
